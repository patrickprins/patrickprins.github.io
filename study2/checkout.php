		...
		<div class="container">
			...
			<div class="checkout-left">	
                ...
                <div style="text-align: center;">
                    <form method="post" action="http://patrickprins.github.io/enquete2v2">
                        <input type="hidden" name="checkout-v2" value="<?php echo $checkout-v2;?>" />
                        <input type="submit" name="Stuur" value="Klaar!" style="height:50px; width:150px; font-size:20px" />
                    </form>
                </div>
